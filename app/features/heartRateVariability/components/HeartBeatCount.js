      ...
      <View style={styles.container}>
        <View style={styles.valueContainer}>
          <Text style={styles.valueHeaderText}>
            {safeMetaLabelFinder("heartRateVariability", "heartBeatCount")}
          </Text>
          <View style={styles.averageValueContainer}>
            ...
            <View style={styles.valueDetailsContainer}>
              <Text style={styles.valueTextDetails}>
                {safeMetaLabelFinder("heartRateVariability", "avgBpm")}
              </Text>
              <Text style={styles.valueTextDetails}>
                {safeMetaLabelFinder("heartRateVariability", "minLabel")}
              </Text>
            </View>
          </View>
