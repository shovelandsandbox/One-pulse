...
const KEYS = {
  ...
  CREATE_NEW_REQUEST: "createNewRequest",
  CHAT_SUPPORT: "chatSupport",
  WRITE_MESSAGE_HERE: "writeMessageHere",
  EXIT_CHAT: "exitChat",
  EXIT_CHATBOT_DESC: "exitChatDesc",
};
...
const screenMeta = () => {
  return {
    ...
    exit_chat_desc: fetchLabel(
      helpers.findElement(VIDEO_SALES, KEYS.EXIT_CHAT),
      "Do you want to exit from Chat window ?"
    ),
    exit_chatbot_desc: fetchLabel(
      helpers.findElement(VIDEO_SALES, KEYS.EXIT_CHATBOT_DESC),
      "If yes, your current conversation will be removed."
    ),
    exit_chatbot: fetchLabel(
      helpers.findElement(VIDEO_SALES, EXIT_CHATBOT),
      "Are you sure that you want to end the conversation?"
    ),
    ...
    createNewRequest: fetchLabel(
      helpers.findElement(VIDEO_SALES, KEYS.CREATE_NEW_REQUEST),
      "Would you like to create a new request?"
    ),
    chatSupport: fetchLabel(
      helpers.findElement(VIDEO_SALES, KEYS.CHAT_SUPPORT),
      "Chat and Support"
    ),
    writeMessageHere: fetchLabel(
      helpers.findElement(VIDEO_SALES, KEYS.WRITE_MESSAGE_HERE),
