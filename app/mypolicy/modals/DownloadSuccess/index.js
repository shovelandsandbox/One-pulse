...
const KEY_MODAL_TITLE = "modal_download_success_title";
const KEY_MODAL_DESC = "modal_download_success_desc";
const KEY_MODAL_BUTTON = "modal_download_success_button";

export default class DownloadSuccess extends Component {
  onConfirm() {
