...
import { goto, gotoWithParams, gotoPulsehealth } from "../../actions";
...
export class ChatConversation extends Component {
  ...
  renderMainView() {
    ...
    const GetStartedMsg = metaHelpers.findElement(NEW_HOME, NEW_HOME_GETSTARTED)
      .label;
    let { ShowHealthAssessmentCarousal } = this.state;
      ...
      <View style={{ backgroundColor: "#fff" }}>
        ...
        <View style={{ marginTop: 24 }}>
          <StaticChatMessageCard
            ...
            // 'I just need a few details from you before we get started'
            title={GetStartedMsg}
            _onPress={() =>
              this.props.gotoWithParams(pageKeys.BABYLON_REGISTRATION, {
