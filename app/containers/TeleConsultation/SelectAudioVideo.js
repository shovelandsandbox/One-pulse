...
import styles from "./consult-doctor-styles";
...
class SelectAudioVideo extends Component {
    constructor(props) {
        ...
        this.text1 = metaHelpers.findElement(TALKTOADOCTOR, TALKTOADOCTOR_NPC).label
        this.permsRequired = [
            {
                key: "camera",
    ...
    componentDidMount() {
        ...
        this.props.dispatch({
            context: pageKeys.DOC_SERVICE_LANDING,
            type: CoreActionTypes.UPDATE_TOKEN,
        });
    ...
    submit() {
        ...
        if (this.callType !== null && this.callType !== undefined) {
            if (this.props.consultationStatus === ConsultationStatus.REQUESTED)
                ...
                if (isPrudentialCustomer || IC) {
                    this.props.navigation.navigate("AppointConfirmation", {
    ...
    onGrantAccess() {
        ...
        allPermissions.then(results => {
            ...
            if (permissionDenied) {
                ...
                this.callType = (this.type === "video") ? ConsultationType.VIDEO_CHAT : ConsultationType.AUDIO_CHAT;
    ...
    requestConsultation = () => {
        ...
        // refreshTokenCall(refreshToken).then(response => {
        //   this.props.dispatch({
        ...
        this.props.dispatch({
            context: pageKeys.DOC_SERVICE_LANDING,
            type: CoreActionTypes.DOC_SERVICE_INITIATE_PAYMENT,
            payload: {
    ...
    showPaymentOptions = () => {
        ...
        const docConsultScreen = helpers.findScreen(
            SCREEN_KEY_DOC_ON_CALL_LANDING
        );
        ...
        return (
            <View style={styles.topView}>
                ...
                >
                    <RadioButton value="" backgroundColor="#ed1b2e" style={{ marginTop: 20 }}>
                        <Text style={styles.radioButtonTextStyle}>
                            {payment_by} <Image source={BOOST_IMAGE} resizeMode="contain" style={styles.boostImageStyle}></Image>
                        </Text>
                    </RadioButton>
                </RadioGroup>
            </View>
    ...
    checkAvailableTime(index) {
        ...
        const notAvailable = helpers.findElementWithScreen(docConsultScreen, NOT_AVAILABLE).label
    ...
    _selectedItem(index, item, serviceId) {
        ...
        // }
        this.setState({
            isCustomerText: isPrudentialCustomer || IC ? this.text : this.text1
        })
    ...
    _renderNewList = () => {
        ...
        const pricing = helpers.findElementWithScreen(
            docConsultScreen,
            PRICING
        ).label;
    ...
    render() {
        ...
        const docTiming = helpers.findElementWithScreen(
            docConsultScreen,
            TIMMING
        ).label;

        const pubholiday = helpers.findElementWithScreen(
            docConsultScreen,
            HOLIDAY
        ).label;
        ...
        const and = helpers.findElementWithScreen(
            docConsultScreen,
            AND
        ).label;
        ...
        const proceed = helpers.findElementWithScreen(
            docConsultScreen,
            PROCEED
        ).label;

        const info = helpers.findElementWithScreen(
            docConsultScreen,
            INFO
        ).label;

        const notes = helpers.findElementWithScreen(
            docConsultScreen,
            NOTES
        ).label;

        const cancel = helpers.findElementWithScreen(
            docConsultScreen,
            KEY_CANCEL
        ).label;
        ...
        this.ok = helpers.findElementWithScreen(
            docConsultScreen,
            KEY_OK
        ).label;
        ...
        this.max = helpers.findElementWithScreen(
            docConsultScreen,
            KEY_MAX
        ).label;
        ...
        const pay = helpers.findElementWithScreen(
            docConsultScreen,
            PAY
        ).label;
        ...
        return <View
            ...
            {this.state.ConsultationAndMedic && <View style={{
                alignItems: "flex-end",
                position: "absolute",
                top: 32,
                right: 10,
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            onPress={() => {
                                this.props.navigation.navigate("ConsulationHistory")
                            }}
                        >
            ...
            <View
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        {metaHelpers.findElement(TALKTOADOCTOR, TALKTOADOCTOR_HOWWOULDYOULIKE).label}
            ...
            <View style={{
                ...
                <Text style={{
                    ...
                    {/* Select an answer */}
                    {metaHelpers.findElement(TALKTOADOCTOR, TALKTOADOCTOR_SELECTANSWER).label}
                </Text>
            </View>
            {
                // this._renderList()
                ...
                >
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            You are not a Prudential customer, so you need to pay the consulation on fees to continue ,are you sure to go for pay ment
                        </Text>
                        <View style={{
                            flexDirection: "row",
                            width: "100%",
...
const mapStateToProps = state => {
    ...
    return {
        ...
        pricing: state.doctorServices.pricing,
