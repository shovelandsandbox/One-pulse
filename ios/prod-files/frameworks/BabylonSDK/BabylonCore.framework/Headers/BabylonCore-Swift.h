...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BabylonCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC11BabylonCore15AppDelegateBase")
...
@interface AppDelegateBase (SWIFT_EXTENSION(BabylonCore))
...
SWIFT_CLASS("_TtC11BabylonCore29MultiUnitMeasurementFormatter")
@interface MultiUnitMeasurementFormatter : NSMeasurementFormatter
@property (nonatomic, copy) NSLocale * _Null_unspecified locale;
